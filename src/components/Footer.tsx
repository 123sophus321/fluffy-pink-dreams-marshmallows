        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#about" className="text-gray-600 hover:text-marshmallow-600">About Us</a>
              </li>
              <li>
                <a href="#products" className="text-gray-600 hover:text-marshmallow-600">Products</a>
              </li>
              <li>
                <a href="#contact" className="text-gray-600 hover:text-marshmallow-600">Contact</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-marshmallow-600">FAQ</a>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-marshmallow-600">Shipping & Returns</a>
              </li>
            </ul>
          </div>
